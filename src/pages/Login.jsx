  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      if (employee.status && employee.status !== "Active") {
        setErrors({
          general: "Your account is currently inactive.",
        });
      ...
      // REMEMBER ME
      if (rememberMe) {
        localStorage.setItem("workpulse_remember_me", "true");
      } else {
        localStorage.removeItem("workpulse_remember_me");
      }

      setSuccess(`Welcome back, ${employee.name}!`);
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#F4EFFA] text-[#2F184B]">
      ...
      >
        ...
        >
          ...
          <div className="mt-5 flex h-12 items-end gap-1.5">
            {[32, 45, 38, 56, 49, 68, 58, 78, 72, 92].map(
              (height, index) => (
                <motion.div
                  key={index}
                  initial={{ height: 0 }}
      ...
      >
        ...
        >
          <div className="relative flex h-10 w-10 items-center justify-center rounded-full bg-[#F4EFFA]">
            <Target size={18} className="text-[#532B88]" />
      ...
      <motion.div
        ...
        className="absolute right-[22%] bottom-[39%] hidden lg:block"
      >
                ...
                >
                  ...
                  <div className="group relative">
                    ...
                    <input
                      ...
                      autoComplete="email"
                      className={`h-[52px] w-full rounded-xl border bg-white/55 pl-11 pr-4 text-sm text-[#2F184B] outline-none transition-all duration-300 placeholder:text-[#B0A2B9] focus:bg-white/80 ${
                        errors.email
                ...
                >
                  ...
                  <div className="group relative">
                    ...
                    <input
                      ...
                      className={`h-[52px] w-full rounded-xl border bg-white/55 pl-11 pr-12 text-sm text-[#2F184B] outline-none transition-all duration-300 placeholder:text-[#B0A2B9] focus:bg-white/80 ${
                        errors.password
                          ? "border-red-400 focus:border-red-500"
                          : "border-[#C8B1E4]/65 focus:border-[#9B72CF] focus:shadow-[0_0_0_4px_rgba(155,114,207,0.10),0_10px_30px_rgba(83,43,136,0.08)]"
                      }`}
                ...
                >
                  <label className="flex cursor-pointer items-center gap-2.5">
                    <input
                      ...
                      className="h-4 w-4 cursor-pointer appearance-none rounded border border-[#C8B1E4] bg-white checked:border-[#532B88] checked:bg-[#532B88]"
                    />
